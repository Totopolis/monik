// Copied from https://www.badflyer.com/asyncmanualresetevent

using System;
using System.Threading;
using System.Threading.Tasks;

namespace Monik.Client.Base
{
    /// <summary>
    ...
    public sealed class ManualResetEventAsync
    {
        ...
        public void Reset()
        {
            ...
            Interlocked.CompareExchange(ref this.completionSource, new TaskCompletionSource<bool>(),
